...
public class NotebookSelection {
    ...
    public NotebookSelection(Set<Notebooks> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public NotebookSelection(Set<Notebooks> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
